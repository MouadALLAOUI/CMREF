...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('det_fact', function (Blueprint $table) {
            ...
            $table->foreignUuid('fact_id')->index()->constrained('fact')->onDelete('cascade'); // Link to Invoice Header
            $table->foreignUuid('livre_id')->nullable()->index()->constrained('livres')->nullOnDelete(); // Link to Book
